                    ...
                    <div class="row">
                        <div class="col col-md-9">
                            <div class="contact-info">
                                <ul>
                                    <li><i class="ti-mobile"></i> (503)7921-1270 / 2272-6609</li>
                                    <li><i class="ti-email"></i> cmasgerencia@gmail.com </li>
                                    <li><i class="ti-time"></i> Lun - Vie 8AM - 5PM</li>
                                </ul>
                            </div>
                        </div>
            ...
            <nav class="navigation navbar navbar-default">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.php"><img src="assets/images/logo-cma.png" alt width="80%"></a>
                    </div>
