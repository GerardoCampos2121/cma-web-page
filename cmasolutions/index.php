...
<head>
    ...
    <title> CMA Soluciones S.A. de C.V. </title>
            ...
            <div class="container">
                ...
                <div class="row well" style="background-color:white;">
                    ...
                    <div class="col-xs-12 col-md-8" style="padding:70px;font-size:18px; text-align:justify"><h2>Consultoría Ambiental</h2>
                                ...
                                <ul> 
                                    ...
                                    <li> Trámites para la obtención de Permisos Ambientales y Modificaciones a Permisos Ambientales</li>
                ...
                <div class="row well">
                    ...
                    <div class="col-xs-12 col-md-8" style="padding:50px;font-size:18px"><h2>Transporte de Desechos</h2>
                         ...
                         <ul>
                        <li>   <u>Permiso Oficial:</u> Contamos con la autorización del Ministerio de Medio Ambiente para el transporte de desechos especiales.</li>
                        <li>   <u>Cobertura Nacional:</u> Realizamos recolección y traslado desde cualquier parte del país.</li>
                        <li>   <u>Seguridad Garantizada:</u> Procesos certificados que aseguran un manejo responsable y seguro.</li>
                        ...
                        <div class="testimonial-grids testimonials-slider">
                            <div class="grid">
                                ...
                                <div class="client-quote">
                                    <p>“collection of textile samples lay spread out on the table Samsa was a travelling salesman and above it there hung a picture that he had recently cut out of an illustrated magazine and housed in a nice, gilded frame. It showed a lady fitted out with a fur”</p>
                                </div>
                            </div>
                            <div class="grid">
                                <div class="client-info">
                    ...
                    <div class="col col-xs-12">
                        <div class="blog-grids">
                            <div class="grid">
                                ...
                                <div class="details">
                                    <h3><a href="#">Garment sector set to take an environmental turn arround the world</a></h3>
                                    <p class="date">Jun 18, 2019</p>
                                    <p>small, lay peacefully between its four familiar walls. A collection of textile samples lay spread</p>
                            ...
                            <div class="grid">
                                ...
                                <div class="details">
                                    <h3><a href="#">Harrowing consequences of a life without hope for small-scale</a></h3>
                                    <p class="date">Jun 18, 2019</p>
                                    <p>small, lay peacefully between its four familiar walls. A collection of textile samples lay spread</p>
                                    <a href="#" class="more">Read more</a>
                                </div>
